  ...
  en: {
    ...
    trial: {
      ...
      cards: [
        ...
        { tag: "GUIDED TOUR", t: "Watch the sign-up walkthrough", s: "A 90-second guided tour of the real screens — business verification, plan and admin, consent, submission — showing what each field is for and where it goes. Korean narration; more tours to follow.", b: "Open the tour (1 min 35 s)", kind: "tour", href: "/tours/signup/" },
      ],
  ...
  ko: {
    ...
    trial: {
      ...
      cards: [
        ...
        { tag: "GUIDED TOUR", t: "가입 화면을 미리 보기", s: "실제 화면을 따라가는 1분 30초 안내 — 사업자 확인, 요금제·관리자, 동의, 접수까지. 어떤 항목을 왜 입력하고 그 값이 어디로 이어지는지 보여드립니다. 온보딩·입력 방법 투어가 이어집니다.", b: "가입 안내 보기 (1분 35초)", kind: "tour", href: "/tours/signup/" },
      ],

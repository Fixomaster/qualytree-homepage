...
export const COPY = {
  en: {
    ...
    nav: { features: "Features", trial: "Try it", signup: "Sign up", about: "Company", contact: "Contact sales", login: "Log in", signupShort: "Sign up", langLabel: "언어", langSwitch: "한국어" },
    trial: {
      number: "08", kicker: "TRY IT",
      titleA: "See it before", titleEm: "you commit", titleB: ".",
      sub: "Two ways to get a feel for Qualytree before signing up. Both are free; neither requires a contract.",
      cards: [
    ...
    contact: {
      ...
      fields: { company: "Company", name: "Name", email: "Email", phone: "Phone (optional)", topic: "Topic", message: "Message" },
      ...
      submit: "Send",
      hint: "Sending opens your email app with the message prepared for",
  ...
  ko: {
    ...
    trial: {
      ...
      sub: "가입 전에 Qualytree를 직접 확인할 수 있는 두 가지 방법입니다. 모두 무료이며 계약이 필요하지 않습니다.",
      cards: [
    ...
    contact: {
      ...
      fields: { company: "회사명", name: "담당자", email: "이메일", phone: "연락처 (선택)", topic: "문의 유형", message: "문의 내용" },
      topics: ["도입 문의", "데모 신청", "체험 계정 신청", "정부지원사업 패키지", "제휴 / 기타"],
      placeholder: "제품, 목표 시장, 현재 관리 방식(종이 / 엑셀 / 다른 소프트웨어), 도입 희망 시기 등",
      submit: "보내기",
      hint: "보내기를 누르면 내용이 채워진 메일 앱이 열립니다. 수신:",
      direct: "또는 직접 메일 보내기:",
    },
    hero: {
      h1a: "품질은",

  ...
  en: {
    ...
    trial: {
      ...
      cards: [
        ...
        { tag: "GUIDED TOUR", t: "Watch the sign-up walkthrough", s: "A 98-second guided tour of the real sign-up screens — business verification, plan and admin, consent, submission — showing what each field is for. Four more guides (onboarding, documents, inspection, change control) can be previewed; full versions unlock after sign-up. Korean narration.", b: "Open the guides (5 tours)", kind: "tour", href: "/tours/" },
      ],
  ...
  ko: {
    ...
    trial: {
      ...
      cards: [
        ...
        { tag: "GUIDED TOUR", t: "가입 화면을 미리 보기", s: "실제 화면을 따라가는 1분 38초 안내 — 사업자 확인, 요금제·관리자, 동의, 접수까지 어떤 항목을 왜 입력하는지 보여드립니다. 온보딩·문서·검사·변경관리 네 편은 앞부분만 미리 보고, 전체는 가입 후 볼 수 있습니다.", b: "가이드 투어 보기 (5편)", kind: "tour", href: "/tours/" },
      ],

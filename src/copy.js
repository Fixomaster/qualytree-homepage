  ...
  en: {
    ...
    trial: {
      ...
      cards: [
        ...
        { tag: "GUIDED TOUR", t: "Watch the sign-up walkthrough", s: "A 98-second guided tour of the real sign-up screens — business verification, plan and admin, consent, submission — showing what each field is for. Onboarding, document, inspection and change-control guides continue inside the platform after sign-up. Korean narration.", b: "Open the tour (1 min 38 s)", kind: "tour", href: "/tours/signup/" },
      ],
  ...
  ko: {
    ...
    trial: {
      ...
      cards: [
        ...
        { tag: "GUIDED TOUR", t: "가입 화면을 미리 보기", s: "실제 화면을 따라가는 1분 38초 안내 — 사업자 확인, 요금제·관리자, 동의, 접수까지 어떤 항목을 왜 입력하는지 보여드립니다. 온보딩·문서·검사 안내는 가입 후 플랫폼 안에서 이어집니다.", b: "가입 안내 보기 (1분 38초)", kind: "tour", href: "/tours/signup/" },
      ],
